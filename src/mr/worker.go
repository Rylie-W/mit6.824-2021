...
//	//CallExample()
//	//args := MrRequest{RequestType: 0,MapOutput: make(map[string] []string)}
//	//reply := MrReply{TaskType: -1}
//	//for reply.MapInput == "" {
//	//	println("ask for task.")
//	//	callTask(&args,&reply)
//	//}
//	//for true{
//	//	fmt.Println(reply.TaskType)
//	//	request:=doTask(reply,mapf,reducef)
//	//	reply := MrReply{TaskType: -1}
//	//	for reply.TaskType==-1{
//	//		callTask(&request,&reply)
//	//	}
//	//	if reply.TaskType==10{
//	//		return
//	//	}
//	//}
//	request := MrRequest{RequestType: 0,MapOutput: make(map[string] []string)}
//	for true{
//		reply := MrReply{TaskType: -1}
//		for reply.TaskType==-1{
//			println("ask for task.")
...
//}
//
//func doTask(task MrReply,mapf func(string, string) []KeyValue,
//	reducef func(string, []string) string) MrRequest {
...
//}
//
//func doMap(task MrReply,mapf func(string, string) []KeyValue) MrRequest{
//	intermediate := []KeyValue{}
//	filename:="../main/"+task.MapInput
...
//		onames=append(onames,oname+string(rune(1)))
//		file,err=os.Create(oname+string(rune(i)))
...
//			return MrRequest{RequestType: http.StatusInternalServerError}
//		}
//	}
//	return MrRequest{0, map[string][]string{filename:onames}}
//}
...
//}
//func callTask(args *MrRequest,reply *MrReply){
	// declare an argument structure.
	//args := MrRequest{RequestType: 0,MapOutput: make(map[string] []string)}
	// declare a reply structure.
	//reply := MrReply{}
	// send the RPC request, wait for the reply.
	//call("Coordinator.AnswerRPC", args, reply)

	//fmt.Printf("reply.taskType %v\n", reply.TaskType)
	//fmt.Println("reply.mapInput\n",reply.MapInput)
